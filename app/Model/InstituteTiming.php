 ...
 * @package     Models
 * @author      Vijay.Ch <vijay.ch@vendus.com>
 * @fileName    InstituteTimingModel.php
 * @description Used for user queies and validations
 * @license     http://www.opensource.org/licenses/mit-license.php MIT License
 * @link        http://localhost/cacsv2/index
 */
class InstituteTiming extends AppModel {
    
    public $name = 'InstituteTiming';
    /**
     ...
     *    or MissingViewException in debug mode.
     */
    public function updateInstituteTimingDetails($updateData, $conditions) {
        try {
     ...
     *    or MissingViewException in debug mode.
     */
    public function fetchTimingsDetailsByInstituteId($instituteId) {
        try {
