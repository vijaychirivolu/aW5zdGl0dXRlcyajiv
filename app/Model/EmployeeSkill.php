 ...
 * @package     Models
 * @author      Vijay.Ch <vijay.ch@vendus.com>
 * @fileName    EmployeeSkillModel.php
...
class EmployeeSkill extends AppModel {
    ...
    public $name = 'EmployeeSkill';
    
    public $belongsTo = array(
        'Skill' => array(
            'className' => 'Skill',
            'conditions' => array('Skill.row_status' => 1),
            'foreignKey' => 'skill'
        )
    );
     ...
     *    or MissingViewException in debug mode.
     */
    public function updateEmployeeSkillDetails($updateData, $conditions) {
        try {
