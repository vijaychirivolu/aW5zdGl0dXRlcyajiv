...
} else if (HTTP_HOST == 'schools.uat.com' || HTTP_HOST == 'http://schools.uat.com') {
    define('ENVIRONMENT', 'staging');
} else if (HTTP_HOST == 'schools.com' || HTTP_HOST == 'http://schools.com') {
    define('ENVIRONMENT', 'production');
} else if (HTTP_HOST == 'schools.dev.com' || HTTP_HOST == 'http://schools.dev.com') {
    define('ENVIRONMENT', 'devserver');
} else {
    define('ENVIRONMENT', '');
}
...
if (isset($_SERVER['HTTP_USER_AGENT']) && $_SERVER['HTTP_USER_AGENT'] !="") {
    ...
    if ($iphone || $android || $palmpre || $ipod || $berry == true || $ipad == true) {
