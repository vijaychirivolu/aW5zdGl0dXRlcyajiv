        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                ?>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label"><?php echo __("Section Name");?></label>
                        <div class="col-sm-6">
                            ...
                            echo  $this->AppForm->input('current_section_id',array(
                                ...
                                'options' => (isset($sectionResult))?$sectionResult:array(),
                                'label'=>false,
                                'div'=>false
                            ));
                            ?>
                    ...
                    <div class="hr-line-dashed"></div>
                    <div class="form-group"><label class="col-sm-2 control-label"><?php echo __("Admission No");?></label>
                        <div class="col-sm-6">
                            <?php
                            echo  $this->AppForm->input('admission_no',array(
                                'type'=>'text',
                                'class'=>'form-control m-b required',
                                'label'=>false,
                                'div'=>false
