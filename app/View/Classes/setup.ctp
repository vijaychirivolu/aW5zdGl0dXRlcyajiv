...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo (isset($id) && $id > 0) ?__("Edit Class"):__("Add Class");?></h2>
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo $this->Html->Url(array("controller"=>"dashboards","action"=>"index"));?>"><?php echo __("Dashboards");?></a>
            </li>
            <li>
                <a href="<?php echo $this->Html->Url(array("controller"=>"classes","action"=>"index"));?>"><?php echo __("Classs");?></a>
            </li>
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <?php
                    ...
                    echo $this->AppForm->create('ClassInfo', array(
                ...
                ?>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label"><?php echo __("Fee Per Year");?></label>
                        <div class="col-sm-6">
                            <?php
                            echo  $this->AppForm->input('fee',array(
                                'type'=>'text',
                                'class'=>'form-control m-b',
                                'label'=>false,
                                'div'=>false
