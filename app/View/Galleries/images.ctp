            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="file-manager">
                        ...
                        <a class="btn btn-primary btn-block" href="<?php echo $this->Html->Url(array("controller"=>"galleries","action"=>"uploads",$galleryId));?>"><?php echo __("Upload Files");?></a>
                        <div class="hr-line-dashed"></div>
                        <h5>Folders</h5>
                        <?php if (!empty($galleriesResult)) {?>
                        <ul class="folder-list" style="padding: 0">
                                <?php foreach($galleriesResult as $key=>$res):?> 
                            <li><a href="<?php echo $this->Html->Url(array("controller"=>"galleries","action"=>"images",$res["Gallery"]["id"]));?>"><i class="fa fa-folder"></i> <?php echo ucwords(stripslashes($res["Gallery"]["name"]));?></a></li>
                                <?php endforeach;?>
                        </ul>
                        <?php } else {
