        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <?php
                    ...
                    echo $this->AppForm->create('Event', array(
                ...
                ?>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label"><?php echo __("Students");?></label>
                    ...
                    <div class="hr-line-dashed"></div>
                    <div class="form-group"><label class="col-sm-2 control-label"><?php echo __("All Day");?></label>
                        <div class="col-sm-6">
                            <?php
                            echo  $this->AppForm->input('all_day',array(
                                'type'=>'checkbox',
                                'multiple' => 'checkbox',
                                'class'=>'i-checks time_hide_show',
                                'label' => false,
                                'value'=>1,
                                'div'=>false,
                                'hiddenField'=>false
                    ...
                    <div class="hr-line-dashed"></div>
                    <div class="table-none" id="time_div">
                    <div class="form-group"><label class="col-sm-2 control-label"><?php echo __("Time");?></label>

                        <div class="col-sm-3">
                            <?php
                            echo  $this->AppForm->input('start_time',array(
                                'type'=>'text',
                        ...
                        <div class="col-sm-3">
                            <?php
                            echo  $this->AppForm->input('end_time',array(
                                'type'=>'text',
                                'class'=>'form-control m-b',
                                'label'=>false,
                                'div'=>false
